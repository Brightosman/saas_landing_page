            ...
            {props.testimonials.map(({text, imageSrc, name, username }) =>(
                <div key={username} className="card">
                    ...
                    <div className="flex items-center gap-2 mt-5">
                        <Image src={imageSrc} alt={name} width={40} height={40} className='h-20 w-20 rounded-full' />
...
//           <div>{text}</div>
//           <div className="flex items-center gap-2 mt-5">
//             <Image src={imageSrc} alt={`Profile picture of ${name}`} width={40} height={40} className="h-20 w-20 rounded-full" />
//             <div className="flex flex-col">
//               <div>{name}</div>
//               <div>{username}</div>
//             </div>
    ...
    <section className="bg-white">
        <div className="container">
            ...
            <div className="flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom, transparent,black_25%,black_75%,transparent)]">
                ...
                <TestimonialsColumn testimonials={thirdColumn} className='hidden lg:block' duration={10}/>
            </div>
